...
insert into users values (5,'Davood Rafiei','dr@ualberta.ca','Edmonton',-7);
insert into users values (34,'John Doe','JD@ualberta.ca','Edmonton',-7);

insert into follows values (29,97,'2021-01-10');
insert into follows values (97,5,'2021-09-01');
insert into follows values (5,34,'2022-11-15');
insert into follows values (34,5,'2022-11-15');
